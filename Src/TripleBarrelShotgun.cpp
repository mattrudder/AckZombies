/**
* @file TripleBarrelShotgun.cpp
* @author Jordan Leckner
* @date Created April 7, 2006
*
* This file includes the definition of the Triple Barrel Shotgun Weapon class
*/
...
/**
* CTripleBarrelShotgunWeapon::CTripleBarrelShotgunWeapon
* @date Modified April 7, 2006
*/
CTripleBarrelShotgunWeapon::CTripleBarrelShotgunWeapon(int nDamage, int nCost, int nAmmo, int nAOE, CCharacter *poCharacter) :
CRayCastWeapon(nDamage, nCost, nAmmo, nAOE, poCharacter)
{
	m_eType = OBJ_WEAPON_TRIPLESHOTGUN;
...
/**
* CTripleBarrelShotgunWeapon::fireWeapon
* @date Modified April 28, 2006
*/
bool CTripleBarrelShotgunWeapon::fireWeapon()
{
	if (!m_nAmmoLeft) // make sure we've got enough ammo
		return false;

	// limit the amount of shooting per second
	if (CTimer::getInstance().getTime() - m_fTimer >= 0.55f)
	{
